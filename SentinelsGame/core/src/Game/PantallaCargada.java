...
public class PantallaCargada extends SettingsScreen {
    int barradevida = 0;
    ...
    public PantallaCargada(Sentinels sent, String perfil) {
        ...
        try {
            while (resultado.next()) {
                Night.corazones = (int) resultado.getFloat("corazones");
                Night.puntuacion = (int) resultado.getFloat("puntuacion");
                barradevida = (int) resultado.getFloat("barraVida");
                NIVEL_ACTUAL = (int) resultado.getFloat("nivelJuego");
            }
    ...
    private void createNight() {
        ...
        try {
        while (resultado.next()) {
            night.position.x = resultado.getFloat("nightX");
            night.position.y = resultado.getFloat("nightY");
